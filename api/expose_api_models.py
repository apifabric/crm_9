...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.CustomerSalesRepAssociation, method_decorators= method_decorators)
    api.expose_object(database.models.SalesRepresentative, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.ProductCategoryAssociation, method_decorators= method_decorators)
    api.expose_object(database.models.ProductSupplierAssociation, method_decorators= method_decorators)
