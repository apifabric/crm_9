...
@Component({
  selector: 'SalesRepresentative-home',
  templateUrl: './SalesRepresentative-home.component.html',
  styleUrls: ['./SalesRepresentative-home.component.scss']
})
export class SalesRepresentativeHomeComponent implements AfterViewInit {
