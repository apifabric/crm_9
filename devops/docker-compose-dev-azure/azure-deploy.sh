...
resourcename="crm9"  # lower case, only
resourcegroup="crm9_rg"
...
# git clone https://github.com/apilogicserver/crm9.git
# cd crm9
...
az group create --name crm9_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group crm9_rg --sku S1 --is-linux
az container create --resource-group crm9_rg --name crm9 --image apilogicserver/crm9:latest --dns-name-label crm9 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//crm9.westus.azurecontainer.io:5656'
